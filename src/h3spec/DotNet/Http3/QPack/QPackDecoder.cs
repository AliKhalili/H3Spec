...
using H3Spec.DotNet.Http2.HPack;
...
namespace System.Net.Http.QPack
{
    internal sealed class QPackDecoder : IDisposable
    {
        ...
        /// </summary>
        public void Reset() => _state = State.RequiredInsertCount;
        ...
        private static bool IsHuffmanEncoded(byte b) => (b & HuffmanMask) != 0;
        ...
        private static void OnIndexedHeaderNamePostBase(int _ /*index*/) => ThrowDynamicTableNotSupported();// TODO update with postbase index// _index = index;// _state = State.HeaderValueLength;

        private static void OnPostBaseIndex() => ThrowDynamicTableNotSupported();// TODO// _state = State.CompressedHeaders;
        ...
        private static void ThrowDynamicTableNotSupported() => throw new QPackDecodingException("SR.net_http_qpack_no_dynamic_table");
    }
}
