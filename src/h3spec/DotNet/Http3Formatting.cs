namespace H3Spec.DotNet
{
    ...
    {
        public static string ToFormattedType(Http3FrameType type) => type switch
        {
        ...
        public static string ToFormattedErrorCode(Http3ErrorCode errorCode) => errorCode switch
        {
